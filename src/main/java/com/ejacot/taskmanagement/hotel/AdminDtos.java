...
public final class AdminDtos {
    ...
    public record ImportPreview(String fileName,int sheets,int employees,int planCells,List<String> days,List<ImportPreviewRow> rows,List<String> warnings) {}
    public record ImportPreviewRow(String employee,List<String> values) {}
}
