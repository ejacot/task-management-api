...
public class RoomAssignment {
 ...
 public Long getId(){return id;} public Hotel getHotel(){return hotel;} public UserAccount getEmployee(){return employee;} public LocalDate getWorkDate(){return workDate;} public String getRoomNumber(){return roomNumber;} public String getCategory(){return category;} public RoomAssignmentStatus getStatus(){return status;} public String getNotes(){return notes;} public UserAccount getCheckedBy(){return checkedBy;} public Instant getCheckedAt(){return checkedAt;} public String getDefectDescription(){return defectDescription;}
}
