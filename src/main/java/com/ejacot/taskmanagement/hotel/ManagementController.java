...
public class ManagementController{
 ...
 @GetMapping("/plans") public List<HotelDtos.PlanView> plans(Authentication a,@RequestParam java.time.LocalDate from,@RequestParam java.time.LocalDate to){return service.plans(a.getName(),from,to);}
 @PostMapping("/plans/copy-week") @PreAuthorize("hasAnyRole('MANAGER','EMPLOYER')") public List<HotelDtos.PlanView> copyWeek(Authentication a,@Valid @RequestBody ManagementDtos.CopyWeekRequest r){return service.copyWeek(a.getName(),r);}
 ...
 @PostMapping("/rooms") @ResponseStatus(HttpStatus.CREATED) @PreAuthorize("hasAnyRole('MANAGER','EMPLOYER')") public List<ManagementDtos.RoomAssignmentView> assignRooms(Authentication a,@Valid @RequestBody ManagementDtos.RoomAssignmentRequest r){return service.assignRooms(a.getName(),r);}
